...
function create_services_cpt() {
	...
	$labels = array(
		'name' => _x( 'Serviceses', 'Post Type General Name', 'textdomain' ),
		'singular_name' => _x( 'Services', 'Post Type Singular Name', 'textdomain' ),
		'menu_name' => _x( 'Serviceses', 'Admin Menu text', 'textdomain' ),
		...
		'all_items' => __( 'All Serviceses', 'textdomain' ),
		...
		'view_items' => __( 'View Serviceses', 'textdomain' ),
		...
		'items_list' => __( 'Serviceses list', 'textdomain' ),
		'items_list_navigation' => __( 'Serviceses list navigation', 'textdomain' ),
		'filter_items_list' => __( 'Filter Serviceses list', 'textdomain' ),
	);
	$args = array(
